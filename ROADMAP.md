...
| --- | --- | --- | --- | --- |
| 1 | Monorepo setup | Implementing; [specification and ticket index](https://github.com/lolmaus/pomeranian/issues/9). [Bootstrap #11](https://github.com/lolmaus/pomeranian/issues/11) implemented in this checkout: reproducible installation and source-free library identities; [acceptance evidence](docs/verification/bootstrap.md). Publication to the shared remote is pending. Remaining: [formatting #12](https://github.com/lolmaus/pomeranian/issues/12), [core checks #13](https://github.com/lolmaus/pomeranian/issues/13), then [lib-essential checks #14](https://github.com/lolmaus/pomeranian/issues/14) after #13. Next preferred slice: `/implement` #12; #13 also has its workspace prerequisite available here. | Node/pnpm/Turbo, version locks, Oxfmt, shared Oxlint/TypeScript, preconfigured core and lib-essential packages without product behavior, checking/fixing scripts, package/export conventions, and development instructions. | None. |
